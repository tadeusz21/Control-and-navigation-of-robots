...
def public_nav_function(context, *args, **kwargs):
    ...
    hello_moveit = get_package_share_directory("hello_moveit")
    ...
    map_path = os.path.join(hello_moveit, "maps", world_name, "map.yaml")
    rviz_config_file = os.path.join(hello_moveit, "config", "rviz", "navigation.rviz")
