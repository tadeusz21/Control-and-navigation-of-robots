...
class LaunchArguments(LaunchArgumentsBase):
    ...
    world_name: DeclareLaunchArgument = DeclareLaunchArgument('world_name', default_value='default_world', description='Name of the Gazebo world to load')
    rviz_config: DeclareLaunchArgument = DeclareLaunchArgument('rviz_config', default_value='nav2_default_view.rviz', description='Path to the RViz configuration file')
